...
#' @keywords internal
#' @description
#' The function \code{d.spls.GLB} performs dimentional reduction combined to variable selection using the
...
#' @param gamma a numeric vector of the norm \eqn{\Omega} of each \eqn{w_g}.
...
d.spls.GLB<- function(X,y,ncp,pctnu,G,gamma,verbose=FALSE)
{
